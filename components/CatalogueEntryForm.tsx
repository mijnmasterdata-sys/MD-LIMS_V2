...
const CatalogueEntryForm: React.FC<CatalogueEntryFormProps> = ({ entry, onSave, onCancel }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 animate-in slide-in-from-bottom-4 duration-300 bg-white dark:bg-gray-800 p-8 rounded-lg border border-gray-200 dark:border-gray-700 shadow-xl mt-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="col-span-1 md:col-span-1">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Test Code</label>
          <input 
            type="text" 
            value={formData.testCode} 
            onChange={(e) => handleChange('testCode', e.target.value)}
            className="w-full bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded px-3 py-2 text-gray-900 dark:text-white focus:border-blue-500 focus:outline-none font-mono" 
          />
        </div>
        ...
        <div className="col-span-1 md:col-span-2">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Analysis Name</label>
          <input 
            type="text" 
        ...
        <div className="col-span-1 md:col-span-2">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Component Name</label>
          <input 
            type="text" 
        ...
        <div className="col-span-1">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Method Type</label>
          <input 
            type="text" 
            value={formData.type} 
         ...
         <div className="col-span-1">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Default Grade</label>
          <input 
            type="text" 
        ...
        <div className="col-span-1">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Rounding</label>
          <input 
            type="text" 
        ...
        <div className="col-span-1">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Priority</label>
          <select 
        ...
        <div className="col-span-1 md:col-span-2 lg:col-span-4 pt-4 border-t border-gray-200 dark:border-gray-700">
           <h3 className="text-sm font-semibold text-blue-600 dark:text-blue-400 mb-4">Matching Intelligence</h3>
        </div>

        <div className="col-span-1 md:col-span-2 lg:col-span-4">
          <label className="block text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">Synonyms (Comma separated)</label>
          <textarea 
            rows={2} 
