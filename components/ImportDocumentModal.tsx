  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-xl w-full max-w-lg p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">Import Specification</h2>
        
        {error && (
          <div className="mb-4 p-3 bg-red-100 dark:bg-red-900/30 border border-red-300 dark:border-red-800 rounded text-red-700 dark:text-red-200 text-sm">
            {error}
          </div>
        )}
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-500 mt-1">Select a pre-defined layout to improve extraction accuracy.</p>
          </div>
          ...
          <div>
            ...
            <div className={`flex items-center justify-center w-full ${text ? 'opacity-50 pointer-events-none' : ''}`}>
              <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-lg cursor-pointer bg-gray-100 dark:bg-gray-700/50 hover:bg-gray-200 dark:hover:bg-gray-700 hover:border-gray-400 dark:hover:border-gray-500 transition-colors">
          ...
          <div className="flex items-center text-gray-400 dark:text-gray-500 text-xs uppercase font-bold tracking-wider">
          ...
          <div>
             ...
             <textarea 
               rows={4} 
               className={`w-full bg-gray-50 dark:bg-gray-900 border border-gray-300 dark:border-gray-600 rounded p-3 text-gray-900 dark:text-white text-sm focus:border-blue-500 focus:outline-none ${file ? 'opacity-50 pointer-events-none' : ''}`}
